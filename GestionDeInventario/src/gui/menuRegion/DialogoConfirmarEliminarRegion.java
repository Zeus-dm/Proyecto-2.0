...
public class DialogoConfirmarEliminarRegion extends javax.swing.JDialog {
    
    PanelMenuRegiones pmr = null;
    
    public DialogoConfirmarEliminarRegion(java.awt.Frame parent, boolean modal, PanelMenuRegiones pmr) {
        super(parent, modal);
        this.pmr = pmr;
    ...
    private void initComponents() {
        ...
        panelConfirmacion.setBackground(Color.decode(Colores.FONDO.getColor(pmr.getFramePrincipal().getModo())));
        panelConfirmacion.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1, Color.decode(Colores.BORDE.getColor(pmr.getFramePrincipal().getModo()))));
    ...
    private void buttonAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonAceptarActionPerformed
        try {
            ...
            Logger.getLogger(DialogoConfirmarEliminarRegion.class.getName()).log(Level.SEVERE, null, ex);
        }
