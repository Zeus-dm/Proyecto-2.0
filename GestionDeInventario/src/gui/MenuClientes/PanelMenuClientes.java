...
public class PanelMenuClientes extends javax.swing.JPanel {
    ...
    private void cargarClientes(List<String> clientes){
    ...
    private void initComponents() {
        ...
        tableClientes.setForeground(Color.decode(Colores.TEXTO.getColor(fp.modo)));
        tableClientes.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {},
                {},
        ...
        tableClientes.setGridColor(Color.decode(Colores.FONDO.getColor(fp.modo)));
