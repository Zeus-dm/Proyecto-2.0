...
public class PanelCrearCliente extends javax.swing.JPanel {
    ...
    public PanelCrearCliente(DialogMenuCliente dmc) {
        this.dmc = dmc;
    ...
    private void initComponents() {
        ...
        labelTitulo.setText(Texto.AGREGAR_CLIENTE.getTexto());
    ...
    private void buttonAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonAceptarActionPerformed
        try {
            ...
            Logger.getLogger(PanelCrearCliente.class.getName()).log(Level.SEVERE, null, ex);
        }
