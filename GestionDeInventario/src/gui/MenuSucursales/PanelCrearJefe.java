...
public class PanelCrearJefe extends javax.swing.JPanel {
    private DialogMenuSucursal dms = null;
    
    public PanelCrearJefe(DialogMenuSucursal dms) {
        this.dms = dms;
    ...
    private void initComponents() {
        ...
        labelTitulo.setText(Texto.AGREGAR_JEFE.getTexto());
    ...
    private void buttonAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonAceptarActionPerformed
        try {
            String ok = dms.controladorSucursal.agregarJefe(dms.nombreSucursal, textNombreJefe.getText(), textEdadJefe.getText());
            if(ok != null){
            ...
            Logger.getLogger(PanelCrearJefe.class.getName()).log(Level.SEVERE, null, ex);
        }
