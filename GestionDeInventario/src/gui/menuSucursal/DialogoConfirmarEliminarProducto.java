...
public class DialogoConfirmarEliminarProducto extends javax.swing.JDialog {
    ...
    public DialogoConfirmarEliminarProducto(java.awt.Frame parent, boolean modal, PanelMenuSucursal pms) {
        super(parent, modal);
        this.pms = pms;
    ...
    private void initComponents() {
        ...
        panelConfirmacion.setPreferredSize(new java.awt.Dimension(450, 140));
        ...
        labelTitulo.setText(Texto.CONFIRMACION_ELIMINAR_PRODUCTO_SUCURSAL.getTexto());
        labelTitulo.setPreferredSize(new java.awt.Dimension(106, 30));
    ...
    private void buttonAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonAceptarActionPerformed
        try {
            pms.controlProducto.eliminarProducto(pms.barCode);
