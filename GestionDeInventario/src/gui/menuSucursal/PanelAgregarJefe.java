...
public class PanelAgregarJefe extends javax.swing.JPanel {

    PanelMenuSucursal pms = null;

    public PanelAgregarJefe(PanelMenuSucursal pms) {
        this.pms = pms;
    ...
    private void buttonAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonAceptarActionPerformed
        ...
        try {
            String error = pms.controlSucursal.agregarJefe(pms.nombreSucursal, textNombre.getText(), textEdad.getText());
            if (error == null) {
            ...
            Logger.getLogger(PanelAgregarJefe.class.getName()).log(Level.SEVERE, null, ex);
        }
