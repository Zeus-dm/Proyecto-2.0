...
public class DialogoConfirmarEliminarSucursal extends javax.swing.JDialog {
    
    PanelMenuSucursal pms = null;
    
    public DialogoConfirmarEliminarSucursal(java.awt.Frame parent, boolean modal, PanelMenuSucursal pms) {
        super(parent, modal);
        this.pms = pms;
    ...
    private void buttonAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonAceptarActionPerformed
        try {
            pms.controlSucursal.eliminarSucursal(pms.nombreSucursal);
            
            PanelMenuRegiones pmr = new PanelMenuRegiones(pms.getFramePrincipal(), pms.controlSucursal.nombreRegion());
            pms.getFramePrincipal().cargarPanel(pms.getFramePrincipal().getPanelPrincipal(), pmr);
            
            setVisible(false);
        } catch (SQLException ex) {
            Logger.getLogger(DialogoConfirmarEliminarSucursal.class.getName()).log(Level.SEVERE, null, ex);
        }
