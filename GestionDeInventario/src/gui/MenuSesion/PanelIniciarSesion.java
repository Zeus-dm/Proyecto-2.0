...
public class PanelIniciarSesion extends javax.swing.JPanel {
    ...
    public PanelIniciarSesion(DialogMenuSesion dms) {
        this.dms = dms;
        
        initComponents();
        this.dms.setSize(365, 264);
    ...
    private void initComponents() {
        ...
        jPanelFondo.setPreferredSize(new java.awt.Dimension(350, 230));
        ...
        labelTitulo.setText(Texto.BOTON_INICIO_SESION.getTexto());
    ...
    private void buttonAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonAceptarActionPerformed
        try {
            ...
            Logger.getLogger(PanelIniciarSesion.class.getName()).log(Level.SEVERE, null, ex);
        }
