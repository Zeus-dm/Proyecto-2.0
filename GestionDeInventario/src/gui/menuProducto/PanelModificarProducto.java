...
public class PanelModificarProducto extends javax.swing.JPanel {
    ...
    public PanelModificarProducto(PanelMenuProductos pmp) {
        this.pmp = pmp;
    ...
    private void initComponents() {
        ...
        textStock.setText("0");
        textStock.setBorder(null/*javax.swing.BorderFactory.createMatteBorder(0, 0, 1, 0, Color.decode(Colores.BORDE.getColor(pmp.getFramePrincipal().getModo())))*/);
    ...
    private void buttonAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonAceptarActionPerformed
        ...
        try {
            String error = pmp.controlProducto.modificarProducto(pmp.barCode, textNombre.getText(), textMarca.getText(), textBarCode.getText(), textPrecio.getText(), textDescripcion.getText());
            if (error == null) {
                if(!(pmp.barCode.equals(textBarCode.getText()))){
                    pmp.barCode = textBarCode.getText();
                }
