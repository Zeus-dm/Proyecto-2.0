...
public class DialogMenuProductosSucursal extends javax.swing.JDialog {
    private FramePrincipal fp = null;
    final FunProductoSucursal controladorProductoSucursal;
    String barCode;
    
    public DialogMenuProductosSucursal(java.awt.Frame parent, boolean modal, FramePrincipal fp, int pos, String barCode, String nombreRegion, String nombreSucursal) {
        super(parent, modal);
        this.fp = fp;
        controladorProductoSucursal = new FunProductoSucursal(this.fp.getSistema(), this.fp.getSistema().obtenerRegion(nombreRegion).obtenerSucursal(nombreSucursal));
