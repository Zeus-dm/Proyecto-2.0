...
public class PanelModificarProducto extends javax.swing.JPanel {
    ...
    public PanelModificarProducto(DialogMenuProducto dmp) {
        ...
        int tamY = dmp.getSize().height - 392;
        
        initComponents();
        this.dmp.setSize(350, 392);
    ...
    private void initComponents() {
        ...
        labelSignoGato.setForeground(Color.decode(Colores.TEXTO.getColor(dmp.getFramePrincipal().modo)));
        ...
        labelSignoPeso.setForeground(Color.decode(Colores.TEXTO.getColor(dmp.getFramePrincipal().modo)));
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jPanelFondo, javax.swing.GroupLayout.DEFAULT_SIZE, 388, Short.MAX_VALUE)
        );
